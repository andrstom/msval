...
final class HomepagePresenter extends BasePresenter {
    ...
    public function renderDefault(int $page = 1): void {
        ...
        // load images
        $this->template->images = $this->dbHandler->getImages()->where('album_id > ?', 1)->order('created_at')->group('name');
        ...
        $this->template->imageAlbums = $this->dbHandler->getImageAlbum()->where('short_name <> ?', 'nezarazeno')->order('name ASC');
        ...
        // load ranks
        $this->template->ranks = $this->dbHandler->getOrganisationRanks();
    }
