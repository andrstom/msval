...
class DbHandler {
    ...
    public function getFiles() {
        return $this->database->table('files')->order('description ASC');
    }
    ...
    public function getFileCategory() {
        return $this->database->table('files_category');
    }
    ...
    /**
     * Get organisation ranks
     * @return object
     */
    public function getOrganisationRanks() {
        return $this->database->table('organisation_ranks');
    }
