...
class OrganisationManager {
    ...
    private const
            ...
            COLUMN_ABOUT = 'section_about',
            COLUMN_UNIVERSAL = 'section_univ',
            COLUMN_NEWS = 'section_news',
            COLUMN_TEAM = 'section_team',
            COLUMN_GALLERY = 'section_gallery',
            COLUMN_SPONSORS = 'section_sponsors',
            COLUMN_CLIENTS = 'section_clients',
            COLUMN_RANK = 'section_rank',
            COLUMN_CONTACT = 'section_contact',
            COLUMN_FOOD = 'section_food',
            COLUMN_DOWNLOAD = 'section_download',
    ...
    public function add($logged_user, $values): void {
        ...
        try {
            ...
            $insert = $this->database->table(self::TABLE_ORGANISATION)->insert([
                        ...
                        self::COLUMN_ABOUT => $values->section_about,
                        self::COLUMN_UNIVERSAL => $values->section_univ,
                        self::COLUMN_TEAM => $values->section_team,
                        self::COLUMN_GALLERY => $values->section_gallery,
                        self::COLUMN_NEWS => $values->section_news,
                        self::COLUMN_SPONSORS => $values->section_sponsors,
                        self::COLUMN_CLIENTS => $values->section_clients,
                        self::COLUMN_RANK => $values->section_rank,
                        self::COLUMN_CONTACT => $values->section_contact,
                        self::COLUMN_FOOD => $values->section_food,
                        self::COLUMN_DOWNLOAD => $values->section_download,
