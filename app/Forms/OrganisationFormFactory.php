...
final class OrganisationFormFactory {
    ...
    public function create($organisation_id, callable $onSuccess): Form {
        ...
        $form->addSelect('section_about', 'O nás', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_univ', 'Univerzální', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_team', 'Team', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_gallery', 'Galerie', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_news', 'Aktuality', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');

        $form->addSelect('section_sponsors', 'Sponzoři', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');

        $form->addSelect('section_clients', 'Klienti', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_rank', 'Hodnocení/Reference', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_contact', 'Kontakty', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_food', 'Jídelníček', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
        
        $form->addSelect('section_download', 'Ke stažení', ['ANO' => 'ANO', 'NE' => 'NE'])
                ->setHtmlAttribute('class', 'form-control');
